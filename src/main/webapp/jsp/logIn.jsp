            ...
            <div class="modal-body">
                <form id="loginForm" class="form-horizontal" role="form">
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="login_mail">邮箱：</label>
                        <div class="col-md-7">
                            <input type="text" class="form-control" id="login_mail" name="login_mail"
                                   placeholder="请输入您的邮箱">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <a href="javascript:void(0)" class="col-md-offset-7 col-md-5" data-toggle="modal"
                           data-target="#register">没有账户？</a>
                        <%--</li>--%>
                    </div>
                </form>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="margin-left: 40px">
                <form id="registerForm" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="idCode" style="padding-left: 0">验证码：</label>
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="idCode" name="idCode" placeholder="请输入验证码">
                        </div>
                        <div class="col-md-2">
                            <a class="btn btn-success" id="id-code-button" onclick="sendIDCode()">获取验证码</a>
                        </div>
                    </div>
