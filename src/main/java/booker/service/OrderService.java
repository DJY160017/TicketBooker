...
public interface OrderService {
     ...
     */
    boolean unSubscribe(OrderID orderID, String account) throws ProgramInvalidException, UserNotExistException, BalanceInsufficientException, PasswordInvalidException;
